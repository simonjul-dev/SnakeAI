...
class Agent():
    def __init__(self):
        ...
        ## --- AJOUT : Chargement du modèle existant --- 
            self.model.load()
            # Si on charge un modèle, on peut réduire l'exploration initiale
            # pour ne pas "casser" ce qu'il a déjà appris.
                #self.n_games = 80 # Par exemple, pour que epsilon soit déjà à 0
